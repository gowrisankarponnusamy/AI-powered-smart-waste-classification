...
# Class names and their environmental impact
class_info = {
...
def predict_with_confidence(image, confidence_threshold=0.6):
    """Enhanced prediction with confidence thresholding and session tracking"""
    if model is None:
        return None, 0, None
...
def real_time_camera():
    """Enhanced real-time camera integration"""
        ...
        if camera_image:
            ...
            with st.spinner("🧠 AI is analyzing..."):
                ...
                if pred_class:
                    ...
                    with action_col3:
                        if st.button("🔄 New Capture", use_container_width=True, key="new_camera"):
                            st.rerun()
